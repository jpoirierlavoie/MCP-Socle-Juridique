...
| # | Décision | Motif |
|---|---|---|
| S1 | Un troisième dépôt, **`MCP-Socle-Juridique`**, source unique du protocole, de l'identité, de la gouverne, du journal et de la sortie structurée. | Deux implémentations du même protocole ne restent pas uniformes par discipline. |
